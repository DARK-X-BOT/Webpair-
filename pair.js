        ...
        try {
            ...
            GlobalTechInc.ev.on("connection.update", async (s) => {
                ...
                if (connection === "open") {
                    ...
                    await GlobalTechInc.sendMessage(userJid, { text: '*`𝐃𝐨𝐧𝐭 𝐬𝐡𝐚𝐫𝐞 𝐭𝐡𝐢𝐬 𝐜𝐨𝐝𝐞 𝐰𝐢𝐭𝐣 𝐚𝐧𝐲𝐨𝐧𝐞!! 𝐔𝐬𝐞 𝐭𝐡𝐢𝐬 𝐜𝐨𝐝𝐞 𝐭𝐨 𝐐𝐮𝐞𝐞𝐧 𝐦𝐢𝐧𝐮𝐤𝐢 𝐦𝐝 𝐜𝐫𝐞𝐚𝐭𝐞 - 𝐰𝐡𝐚𝐭𝐬𝐚𝐩𝐩 𝐮𝐬𝐞𝐫 𝐛𝐨𝐭 ◦ *Github:* https://github.com/ADHI-OFC-RK/-\n' });
